...
class Inventory(db.Model):
    ...
    def __repr__(self):
        return f"Inventory(id={self.id}, user_id={self.user_id}, item_name={self.item_name}, expiry_date={self.expiry_date}, purchase_date={self.purchase_date}, category={self.category}, price={self.price})"
...
def inventory():
    if request.method == 'POST':
            ...
            new_item = Inventory(user_id=current_user.id, item_name=item_name, expiry_date=expiry_date, purchase_date=purchase_date,category=category, price=price)
...
def add_task():
        ...
        """purchase_date = request.form['purchase_date']
        print("Purchase Date String:", purchase_date_str)

            # Convert the purchase_date string to a Python date object
        purchase_date_str = date.fromisoformat(purchase_date_str) """
        category = request.form['category']
        price = request.form['price']
